...
await build({
  ...
  package: {
    name: "@coinset/gmocoin",
    version: Deno.args[0]?.replace(/^v/, ""),
    description: "Universal GMO Coin API client",
    license: "MIT",
    sideEffects: false,
    "publishConfig": {
      "access": "public",
    ...
    repository: {
      type: "git",
      url: "https://github.com/coinset/gmocoin.git",
    },
    bugs: {
      url: "https://github.com/coinset/gmocoin/issues",
    },
    homepage: "https://github.com/coinset/gmocoin#readme",
    funding: {
      type: "patreon",
